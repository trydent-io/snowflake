...
import static com.googlecode.lanterna.gui2.GridLayout.*;
...
public class SnowflakeCli {
  public static void main(String[] args) {
    ...
    try (final var screen = terminalFactory.createScreen()) {
      ...
      final var timezones = List.of(TimeZone.getAvailableIDs());
      final var readOnlyComboBox = new ComboBox<>(timezones);
